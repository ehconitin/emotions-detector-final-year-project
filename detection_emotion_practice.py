...
def files_count():
    ...
    happy = 'C:/project files/dataset/happy'
    ...
    fear = 'C:/project files/dataset/fear'
    ...
    sad = 'C:/project files/dataset/sad'
    ...
    neutral = 'C:/project files/dataset/neutral'
    ...
    if int(number_of_Happy_files) > int(number_of_Fear_files) and int(number_of_Happy_files) > int(number_of_sad_files) and int(number_of_Happy_files) > int(number_of_neutral_files):
        str_label="Lecture Evaluation is = 75% and Lecture Was Excellent "
        print(str_label)
        ...
        str_label = "Lecture Evaluation is = 65% and Lecture Was Good "
        print(str_label)
        ...
        str_label = "Lecture Evaluation is = 50% and Lecture Was Better "
        print(str_label)
        ...
        str_label = "Lecture Evaluation is = 40% and Lecture Was better but can't clear and understand concept "
        print(str_label)
